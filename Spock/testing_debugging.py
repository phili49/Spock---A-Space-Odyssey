...
"""
Bug #4:(Phil)
User is able to use non-weapon items in battles with enemies

"""
"""
Bug #5 (Phil):
Loading screen is displayed after any item use, increasing impatience, reducing usability and desire to keep playing
"""